...
import 'core/controllers/mapbox_controller.dart' as _i33;
...
import 'features/domain/usecases/search/add_to_search_history.dart' as _i29;
import 'features/domain/usecases/search/get_search_history.dart' as _i30;
import 'features/domain/usecases/search/get_search_results.dart' as _i31;
...
import 'features/presentation/blocs/search/search_bloc.dart' as _i32;
import 'features/presentation/blocs/tour/tour_bloc.dart' as _i28;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i20.GetEnhancedTour>(
      () => _i20.GetEnhancedTour(repository: get<_i17.TourRepository>()));
  gh.lazySingleton<_i21.GetPathToTour>(
      () => _i21.GetPathToTour(repository: get<_i17.TourRepository>()));
  gh.lazySingleton<_i22.GetTour>(
      () => _i22.GetTour(repository: get<_i17.TourRepository>()));
  gh.factory<_i23.NavigationBloc>(() => _i23.NavigationBloc(
      getNavigationData: get<_i7.GetNavigationData>(),
      getPathToTour: get<_i21.GetPathToTour>(),
      distanceHelper: get<_i6.DistanceHelper>()));
  ...
  gh.factory<_i26.SearchResultRepository>(() => _i27.SearchResultRepositoryImpl(
      ...
      remoteDataSource: get<_i25.SearchResultRemoteDataSource>()));
  gh.lazySingleton<_i28.TourBloc>(() => _i28.TourBloc(
      getTour: get<_i22.GetTour>(),
      getAlternativeTours: get<_i19.GetAlternativeTours>(),
      getEnhancedTour: get<_i20.GetEnhancedTour>()));
  gh.lazySingleton<_i29.AddToSearchHistory>(() =>
      _i29.AddToSearchHistory(repository: get<_i26.SearchResultRepository>()));
  gh.lazySingleton<_i30.GetSearchHistory>(() =>
      _i30.GetSearchHistory(repository: get<_i26.SearchResultRepository>()));
  gh.lazySingleton<_i31.GetSearchResults>(() =>
      _i31.GetSearchResults(repository: get<_i26.SearchResultRepository>()));
  await gh.factoryAsync<_i32.SearchBloc>(
      () => _i32.SearchBloc.create(
          getSearchResults: get<_i31.GetSearchResults>(),
          getSearchHistory: get<_i30.GetSearchHistory>(),
          addToSearchHistory: get<_i29.AddToSearchHistory>()),
      preResolve: true);
...
class _$ClientModule extends _i34.ClientModule {}

class _$GpxParserModule extends _i35.GpxParserModule {}

class _$LocationModule extends _i34.LocationModule {}

class _$RtxParserModule extends _i35.RtxParserModule {}
